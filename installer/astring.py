...
def main():
    ...
    if Sonuc == "2":
        ...
        if soup.title.string == "Create new application":
            ...
            if app_title == '':
                app_title = choice(["sir", "siri", "sirii", "siriii", "sirs", "siris"]) + choice(["", "-", "+", " "]) + choice(["user", "bot", "bote", "userb", "ub", "ubot"]) + choice([str(randint(10000, 99999)), ""])
            app_shortname = soru(LANG['WHATIS_SAPPNAME'])
            if app_shortname == '':
                app_shortname = choice(["sir", "siri", "sirii", "siriii", "sirs", "siris"]) + choice(["", "-", "+", " "]) + choice(["user", "bot", "bote", "userb", "ub", "ubot"]) + choice([str(randint(10000, 99999)), ""])
            AppInfo = {
                "hash": hashh,
                "app_title": app_title,
